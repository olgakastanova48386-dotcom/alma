...
export async function GET(request: Request) {
  try {
    ...
    const activeSessions = await db.prepare("SELECT COUNT(DISTINCT user_id) AS total FROM sessions WHERE expires_at > ?").bind(now).first();
