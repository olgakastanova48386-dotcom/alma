  ...
  return (
    <>
      ...
      <section className="alma-home-hero relative h-[540px] sm:h-[570px] md:h-auto md:min-h-[680px] flex items-start md:items-center pt-0 md:pt-28 pb-0 overflow-hidden bg-[#f7f4ef] text-black">
        <div className="alma-home-hero-image alma-aura-host md:hidden absolute inset-x-0 top-0 h-[300px] overflow-hidden bg-[#f3f0e9]"><InteractiveAura /></div>
        <div className="md:hidden pointer-events-none absolute inset-x-0 top-0 h-[300px] bg-gradient-to-b from-transparent via-transparent to-[#f7f4ef]/25" />
        ...
        <div className="absolute inset-x-0 top-[315px] md:top-auto md:bottom-auto z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 md:px-4 md:relative md:inset-auto lg:px-8"><div className="max-w-[650px]">
