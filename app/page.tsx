...
export default function HomePage() {
  ...
  return (
    <main className="min-h-screen overflow-x-hidden bg-[#f7f4ef] text-black">
      <section className="relative h-[420px] sm:h-[460px] md:h-auto md:min-h-[680px] flex items-start md:items-center pt-[104px] sm:pt-[120px] md:pt-28 pb-0 overflow-hidden bg-[#f7f4ef] text-black">
      ...
      <div id="alma-filters" className="relative z-10 -mt-1 bg-[#f7f4ef] pt-5 sm:pt-6 md:mt-0 md:pt-0">
