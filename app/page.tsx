      ...
      <section className="relative min-h-[560px] md:min-h-[820px] flex items-start md:items-center pt-[170px] md:pt-28 pb-8 sm:pb-20 overflow-hidden bg-[#efe9e1] text-black">
        ...
        <div className="absolute inset-x-0 bottom-8 z-10 w-full px-4 sm:relative sm:inset-auto sm:bottom-auto sm:max-w-7xl sm:mx-auto sm:px-6 lg:px-8"><div className="max-w-[760px]">
          ...
          <div className="mt-4 sm:mt-9 grid grid-cols-3 gap-1.5 sm:flex sm:flex-wrap sm:gap-3">
            <button type="button" onClick={scrollToFilters} className="min-w-0 overflow-hidden whitespace-nowrap rounded-full bg-white text-black md:bg-black md:text-white px-1.5 sm:px-7 py-2.5 sm:py-4 text-[clamp(9px,2.7vw,11px)] sm:text-base font-semibold leading-none hover:opacity-80 hover:scale-[1.02] transition">Найти место</button>
            <button type="button" onClick={() => router.push("/surprise")} className="min-w-0 overflow-hidden whitespace-nowrap rounded-full bg-black/55 md:bg-white/80 backdrop-blur-md border border-white/25 md:border-black/10 text-white md:text-black px-1.5 sm:px-7 py-2.5 sm:py-4 text-[clamp(9px,2.7vw,11px)] sm:text-base font-medium leading-none hover:scale-[1.02] transition shadow-sm">✦ Готовый план</button>
            <button type="button" onClick={scrollToPhotozones} className="min-w-0 overflow-hidden whitespace-nowrap rounded-full bg-black/55 md:bg-white/80 backdrop-blur-md border border-white/25 md:border-black/10 text-white md:text-black px-1.5 sm:px-7 py-2.5 sm:py-4 text-[clamp(9px,2.7vw,11px)] sm:text-base font-medium leading-none hover:scale-[1.02] transition shadow-sm">📸 Фотозоны</button>
          </div>
        </div></div>
