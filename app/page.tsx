  ...
  return (
    <main className="min-h-screen overflow-x-hidden bg-[#f7f4ef] text-black">
      <section className="relative min-h-[560px] md:min-h-[820px] flex items-start md:items-center pt-[170px] md:pt-28 pb-8 sm:pb-20 overflow-hidden bg-[#efe9e1] text-black">
        ...
        <div className="absolute left-4 top-[82px] z-20 md:hidden"><div className="inline-flex rounded-full bg-white/82 px-2.5 py-1.5 text-[11px] text-neutral-800 shadow-sm backdrop-blur-md border border-white/30">✨ Открой Санкт-Петербург по-новому</div></div>
        ...
        <div className="absolute inset-x-0 bottom-8 z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 md:relative md:inset-auto md:bottom-auto lg:px-8"><div className="max-w-[760px]">
          ...
          <div className="mt-4 md:mt-9 grid grid-cols-3 gap-1.5 md:flex md:flex-wrap md:gap-3">
            ...
            <button type="button" onClick={() => router.push("/surprise")} className="group relative min-w-0 overflow-hidden whitespace-nowrap rounded-full border border-[#f4d37c] bg-[#f4d37c] px-3 py-2.5 text-[11px] font-bold leading-none text-black shadow-[0_8px_28px_rgba(244,211,124,.58)] ring-2 ring-[#f4d37c]/35 transition duration-300 motion-safe:animate-[pulse_2.4s_ease-in-out_infinite] hover:-translate-y-0.5 hover:scale-[1.06] hover:bg-[#ffe39a] hover:shadow-[0_12px_38px_rgba(244,211,124,.72)] focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-[#f4d37c]/50 md:px-7 md:py-4 md:text-base"><span className="mr-1.5 inline-block" aria-hidden="true">✦</span>Удиви меня</button>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14 sm:py-28"><div className="grid lg:grid-cols-[0.8fr_1.2fr] gap-7 sm:gap-10 lg:gap-20 items-end"><div><h2 className="max-w-full text-[clamp(30px,8vw,60px)] font-bold tracking-tight leading-[1.02] text-black break-words">Не просто<br />список мест</h2></div><p className="text-base sm:text-xl leading-7 sm:leading-8 text-neutral-500 max-w-2xl">Вместо бесконечного поиска выбирай, как ты хочешь провести время — а ALMA покажет подходящие места.</p></div></section>
