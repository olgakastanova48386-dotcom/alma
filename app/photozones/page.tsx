...
const zones: Zone[] = [
 {name:"Кафе Зингер",image:"/images/кафе зингер.jpg",area:"Невский проспект, 28",category:"Архитектура",note:"Кофе у арочного окна с видом на Казанский собор — один из самых узнаваемых петербургских кадров.",best:"Днём · у окна",tall:true,premium:true},
 {name:"Дом Бака",image:"/place-images/5001.jpg",area:"Кирочная улица",category:"Архитектура",note:"Воздушные галереи, старый двор и тот самый петербургский кадр вверх.",best:"Мягкий дневной свет",tall:true},
 {name:"Мозаичный дворик",image:"/images/mosaic-yard.jpg",area:"ул. Чайковского, 2/7",category:"Необычные",note:"Цвет, мозаика и детали — особенно хорош, когда Петербург серый.",best:"Днём"},
 {name:"Севкабель Порт",image:"/images/sevcable.jpg",area:"Кожевенная линия",category:"Закат",note:"Индустриальный берег, вода и большое небо. Здесь кадр делает свет.",best:"За час до заката",tall:true,premium:true},
 ...
 {name:"Новая Голландия",image:"/images/new-holland.jpg",area:"остров Новая Голландия",category:"Романтика",note:"Кирпич, вода и спокойная геометрия для городских кадров вдвоём.",best:"Вечер",premium:true},
