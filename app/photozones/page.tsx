 ...
 return <main className="min-h-screen bg-[#f4f0e9] pt-24 sm:pt-28 pb-24 text-black">
  <section className="mx-auto max-w-[1440px] px-4 sm:px-6 lg:px-10">
   <div className="border-b border-black/10 pb-8 sm:pb-12 lg:grid lg:grid-cols-[1.25fr_.75fr] lg:items-end lg:gap-16">
    ...
    <div className="mt-7 lg:mt-0"><p className="max-w-md text-base sm:text-lg leading-7 text-neutral-600">Не список достопримечательностей, а места, ради которых хочется достать камеру. Выбирай настроение — ALMA подскажет, где получится тот самый кадр.</p><p className="mt-4 text-xs text-neutral-400">Вдохновлено визуальной эстетикой городских фотоподборок. Фотографии используются как иллюстрация локаций.</p></div>
   </div>
