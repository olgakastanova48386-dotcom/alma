...
const zones: Zone[] = [
 {name:"Кафе Зингер",image:"/images/cafe-zinger-photozone.jpg",area:"Невский проспект, 28",category:"Архитектура",note:"Кофе у арочного окна с видом на Казанский собор — один из самых узнаваемых петербургских кадров.",best:"Днём · у окна",tall:true,premium:true},
