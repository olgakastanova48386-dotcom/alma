      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative overflow-visible rounded-[20px] sm:rounded-[28px] bg-[#dfe8d8] px-4 py-3 pr-[112px] min-h-[125px] sm:px-8 sm:py-5 sm:pr-[220px] sm:min-h-[170px] md:min-h-[185px] md:pr-[310px] lg:min-h-[190px] lg:px-9 lg:py-6 lg:pr-[390px]">
          ...
          <img
            ...
            alt="Пёс ALMA"
            className="pointer-events-none absolute bottom-[-6px] right-[3px] z-20 block w-[125px] max-h-[145px] object-contain object-bottom drop-shadow-[0_10px_16px_rgba(0,0,0,0.14)] sm:bottom-[-18px] sm:right-[-8px] sm:w-[240px] sm:max-h-none md:bottom-[-20px] md:right-[4px] md:w-[360px] md:max-h-none lg:bottom-[-42px] lg:right-[18px] lg:w-[430px] lg:max-h-none"
          />
        </div>
        <div className="mx-auto mt-2.5 w-[96%] rounded-[16px] sm:rounded-[20px] bg-white border border-black/5 p-2 sm:mt-5 sm:w-[94%] sm:rounded-[22px] sm:p-5">
          ...
          {filtered.map((place) => {
            ...
            return (
              ...
              >
                ...
                {place.imageUrl ? (
                  <div className="h-32 sm:h-48 overflow-hidden bg-[#ebe7df]">
                    <img
                      src={place.imageUrl}
                  ...
                  <div className="h-32 sm:h-48 bg-[#ebe7df] flex items-center justify-center">
                ...
                <div className="p-3.5 sm:p-7">
                  ...
                  <div className="mt-2.5 sm:mt-4 flex flex-wrap items-center gap-1.5 sm:gap-2">
                  ...
                  <p className="mt-2.5 sm:mt-4 text-sm sm:text-base text-neutral-500">{place.address}</p>
                  ...
                  <div className="mt-3 sm:mt-6 rounded-[16px] sm:rounded-[22px] bg-[#f7f4ef] p-3 sm:p-5">
                    <p className="text-sm font-semibold">Размер собаки</p>
                    <p className="mt-1 text-neutral-600">{place.dogSize}</p>
                    <p className="mt-2.5 sm:mt-4 text-xs sm:text-sm font-semibold">Условия</p>
                    <p className="mt-1 text-xs leading-5 sm:text-sm sm:leading-6 text-neutral-600">
                      {place.dogRules}
                    </p>
                  </div>
                  <div className="mt-3 sm:mt-5 flex items-center justify-between gap-3 sm:gap-4">
                    ...
                    {mapId && (
                      <Link
                        ...
                        className="relative z-20 shrink-0 inline-flex h-9 w-9 sm:h-12 sm:w-12 items-center justify-center rounded-full bg-black text-white transition hover:scale-105"
                      >
                        <svg
                          viewBox="0 0 24 24"
                          width="23"
