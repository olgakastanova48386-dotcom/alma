          ...
          {restaurantPlaces.map((place) => (
            ...
            >
              <div className="flex items-start justify-between gap-4">
                <div>
                  <p className="text-xs uppercase tracking-[0.16em] text-neutral-400">Ресторан</p>
              ...
              <div className="mt-5 space-y-2 text-sm text-neutral-600">
                ...
                {place.averageBill && (
                  <p><span className="text-black font-medium">Средний счёт:</span> {place.averageBill}</p>
                )}
                {place.phone && (
                  <p><span className="text-black font-medium">Телефон:</span> {place.phone}</p>
                )}
                {place.dogFriendly && (
