    ...
    <header className="absolute top-0 left-0 z-[9999] w-full md:fixed">
      <div className="max-w-7xl mx-auto mt-[calc(env(safe-area-inset-top)+10px)] md:mt-4 px-2.5 md:px-6">
        <div className="px-3 py-1.5 md:rounded-full md:border md:border-black/5 md:bg-white/92 md:px-8 md:py-3 md:shadow-lg md:backdrop-blur-xl">
          ...
          {!authScreen && <nav aria-label="Основная навигация" className="alma-foggy-glass fixed inset-x-3 bottom-[calc(10px+env(safe-area-inset-bottom))] z-[10000] mx-auto grid max-w-[480px] grid-cols-5 rounded-[24px] border border-black/10 bg-white/95 px-1.5 py-1.5 shadow-[0_12px_40px_rgba(0,0,0,.16)] backdrop-blur-xl md:hidden">
            {[
