  ...
  return <section className="bg-[#f7f4ef] pb-10 pt-0 text-black">
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="alma-map-layout grid grid-cols-[40%_minmax(0,1fr)] items-start gap-2 sm:grid-cols-1 sm:gap-3 lg:grid-cols-[320px_minmax(0,1fr)] lg:gap-5">
        ...
        <div>
          <div className="alma-map relative min-h-[350px] overflow-hidden rounded-[20px] border border-black/5 bg-[#ebe8e3] shadow-[0_24px_70px_-38px_rgba(0,0,0,.45)] sm:min-h-[440px] sm:rounded-[34px] lg:min-h-[350px] lg:h-[350px]">
    ...
    <style jsx global>{`.alma-map-search{width:100%;}.alma-map-search>div{max-width:400px;margin-inline:auto}.alma-map-search input{font-size:13px}
...
.alma-map-layout{position:relative!important;display:block!important;min-height:180px!important}
