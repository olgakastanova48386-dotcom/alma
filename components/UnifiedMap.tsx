...
export default function UnifiedMap() {
  ...
  return <section className="bg-[#f7f4ef] pb-10 pt-0 text-black">
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="alma-map-layout grid grid-cols-[minmax(0,42%)_minmax(0,58%)] items-start gap-2.5 sm:grid-cols-1 sm:gap-3 lg:grid-cols-[320px_minmax(0,1fr)] lg:gap-5">
        <aside className="alma-map-filters rounded-[22px] border border-black/5 bg-white p-3 shadow-[0_18px_55px_-35px_rgba(0,0,0,.35)] sm:rounded-[30px] sm:p-5 lg:sticky lg:top-24">
        ...
        <div>
          <div className="alma-map relative min-h-[430px] overflow-hidden rounded-[22px] border border-black/5 bg-[#ebe8e3] shadow-[0_24px_70px_-38px_rgba(0,0,0,.45)] sm:min-h-[580px] sm:rounded-[34px] lg:min-h-[720px]">
