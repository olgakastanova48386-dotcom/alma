...
export default function UnifiedMap() {
  ...
  return <section className="bg-[#f7f4ef] pb-10 pt-0 text-black">
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="alma-map-layout grid grid-cols-[128px_minmax(0,1fr)] items-start gap-2 sm:grid-cols-1 sm:gap-3 lg:grid-cols-[320px_minmax(0,1fr)] lg:gap-5">
        <aside className="alma-map-filters rounded-[20px] border border-black/5 bg-white p-2.5 shadow-[0_18px_55px_-35px_rgba(0,0,0,.35)] sm:rounded-[30px] sm:p-5 lg:sticky lg:top-24">
          ...
          {[
            ...
            <div key={filter.label} className="relative">
              <button type="button" onClick={() => setOpenFilter((current) => current === filter.label ? null : filter.label)} className="alma-map-filter-button flex h-10 w-full items-center justify-between rounded-xl border border-black/5 bg-[#f7f4ef] px-2.5 text-left text-[11px] font-medium transition hover:border-black/15 sm:h-12 sm:rounded-2xl sm:px-4 sm:text-sm">
        ...
        <div>
          <div className="alma-map relative min-h-[430px] overflow-hidden rounded-[20px] border border-black/5 bg-[#ebe8e3] shadow-[0_24px_70px_-38px_rgba(0,0,0,.45)] sm:min-h-[580px] sm:rounded-[34px] lg:min-h-[720px]">
