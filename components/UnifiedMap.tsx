...
.alma-map-layout{grid-template-columns:minmax(0,1fr)!important;gap:10px!important}
.alma-map-layout>div{min-width:0}
.alma-map-filters{width:100%!important;height:auto!important;min-height:0!important;overflow:visible!important;padding:10px!important;border-radius:20px!important}
.alma-map-filter-stack{display:grid!important;grid-template-columns:repeat(2,minmax(0,1fr))!important;gap:7px!important}
.alma-map-filter-stack>div{min-width:0}
.alma-map-filter-button{height:42px!important;width:100%!important;border-radius:13px!important;padding:0 9px!important;font-size:11px!important}
...
.alma-map-filter-button+div{position:fixed!important;left:16px!important;right:16px!important;top:auto!important;bottom:82px!important;min-width:0!important;max-height:48vh;overflow:auto;border-radius:22px!important;padding:7px!important}
.alma-map-filter-button+div button{font-size:14px!important;padding:11px 12px!important}
.alma-map-filters button[aria-pressed]{height:44px!important;min-height:44px!important;gap:6px!important;border-radius:13px!important;padding:6px 9px!important;font-size:10px!important;line-height:1.05}
...
.alma-map-filter-stack>button:last-child{grid-column:1/-1!important;margin-top:0!important;padding:8px!important;font-size:10px!important;line-height:1.1}
.alma-map-filters>div:nth-child(2),.alma-map-filters>div:nth-child(3),.alma-map-filters>div:nth-child(4){display:none}
.alma-map-layout .alma-map{height:360px!important;min-height:360px!important;border-radius:20px!important}
.alma-map-search{margin-top:0!important}
.alma-map-layout .alma-map .leaflet-control-zoom{display:none}
.alma-map-layout .alma-map .alma-marker{transform:scale(.72)}
