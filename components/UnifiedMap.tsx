...
.alma-map-layout{display:flex!important;flex-direction:column!important;gap:12px!important}
.alma-map-filters{position:relative!important;z-index:900!important;width:100%!important;padding:14px!important;border-radius:22px!important;background:#fff!important;box-shadow:0 8px 26px rgba(0,0,0,.06)!important}
...
.alma-map-filter-button{height:48px!important;padding:0 12px!important;font-size:13px!important;border-radius:14px!important}
...
.alma-map-filters button[aria-pressed]{min-height:48px!important;gap:6px!important;border-radius:14px!important;padding:7px 9px!important;font-size:11px!important;line-height:1.15;text-align:left}
...
.alma-map-filter-stack>button:last-child{grid-column:1/-1;min-height:40px!important;font-size:12px!important}
.alma-map-filters>div:nth-child(2){display:block!important;margin-top:12px!important;padding-top:12px!important}
