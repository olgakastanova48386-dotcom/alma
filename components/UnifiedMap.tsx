...
export default function UnifiedMap() {
  ...
  return <section className="bg-[#f7f4ef] pb-10 pt-0 text-black">
    ...
    <style jsx global>{`.alma-map-filters .alma-embossed-button,.alma-map-filters .alma-embossed-toggle{box-shadow:inset 0 1px 0 rgba(255,255,255,.95),inset 0 -1px 0 rgba(0,0,0,.06),0 4px 0 #d7d0c7,0 12px 20px rgba(41,34,28,.16);background-image:linear-gradient(160deg,#fff 0%,#f5f1eb 100%);transition:transform .16s ease,box-shadow .16s ease,background .2s ease}
...
.alma-map-filters .alma-embossed-button.bg-black,.alma-map-filters .alma-embossed-toggle[aria-pressed="true"]{background-image:linear-gradient(145deg,#34312f,#0f0e0d);box-shadow:inset 0 1px 0 rgba(255,255,255,.2),inset 0 -2px 5px rgba(0,0,0,.3),0 4px 0 #8b837d,0 12px 20px rgba(0,0,0,.24)}
.alma-map-filters .alma-embossed-toggle:has(svg):not([aria-pressed="true"]){background-image:linear-gradient(145deg,#fff9fa,#f7e5eb);box-shadow:inset 0 1px 0 #fff,0 4px 0 #e4bac7,0 12px 20px rgba(111,36,55,.16)}
.alma-map-filters .alma-embossed-toggle[aria-pressed="true"]:has(svg){background-image:linear-gradient(145deg,#8f455f,#57243a);box-shadow:inset 0 1px 0 rgba(255,255,255,.26),inset 0 -2px 5px rgba(0,0,0,.2),0 4px 0 #bc8798,0 12px 20px rgba(89,38,58,.24)}
.alma-map-filters .alma-embossed-track{box-shadow:inset 0 3px 7px rgba(0,0,0,.27),0 1px 0 rgba(255,255,255,.8);background-image:linear-gradient(140deg,#d7d3cf,#ebe7e3)}
...
.alma-map-filters .alma-embossed-knob{background:#fff!important;box-shadow:inset 0 1px 1px #fff,inset 0 -2px 3px rgba(0,0,0,.1),0 3px 7px rgba(0,0,0,.3)}
