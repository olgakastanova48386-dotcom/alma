...
const verifiedStories:Record<string,string>={
  ...
  "исаакиевская площадь":"Площадь формировалась вокруг Исаакиевского собора и стала частью парадного центра Петербурга. Интересная деталь: электрическое освещение самого собора компания Siemens начала устанавливать ещё в 1880-х годах.",
};
