...
const verifiedStories:Record<string,string>={
  ...
  "исаакиевская площадь":"На площади стоит памятник Николаю I, открытый в 1859 году. Для своего времени он был инженерным чудом: огромная конная статуя опирается всего на две точки — задние ноги коня.",
  "эрарта":"Эрарта открылась в 2010 году после трёх лет подготовки. Сегодня это крупнейший частный музей современного искусства в России.",
  "пушкинская-10":"История арт-центра началась в 1989 году: независимые художники и музыканты заняли расселённый аварийный дом и создали здесь свободную творческую коммуну.",
  "пушкинская, 10":"История арт-центра началась в 1989 году: независимые художники и музыканты заняли расселённый аварийный дом и создали здесь свободную творческую коммуну.",
  "ботанический сад петра великого":"Сад вырос из петербургского Аптекарского огорода начала XVIII века, где по распоряжению Петра I выращивали лекарственные травы и цветы. От него получил название и Аптекарский остров.",
  "ботанический сад":"Сад вырос из петербургского Аптекарского огорода начала XVIII века, где по распоряжению Петра I выращивали лекарственные травы и цветы. От него получил название и Аптекарский остров.",
};
